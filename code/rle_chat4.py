#
# Run length encoding by ChatGPT, version 4
#
...
def rle_encode(data):
    ...
    even for single occurrences of characters, to avoid confusion with digits.
...
def rle_decode(encoded_data):
    ...
    assuming counts are wrapped in parentheses even for single occurrences.
